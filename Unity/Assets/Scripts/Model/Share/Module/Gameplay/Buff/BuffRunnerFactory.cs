...
namespace ET
{
    ...
    /// </summary>
    [Code]
    public class BuffRunnerFactory : Singleton<BuffRunnerFactory>, ISingletonAwake
    {
        private readonly Dictionary<Type, IBuffRunner> allBuffRuners = new();
        ...
        public IBuffRunner Get(BuffDataBase buffData)
        {
            Type buffDataType = buffData.GetType();
