...
{
    [Config]
    public partial class MaterialReactionConfigCategory : Singleton<MaterialReactionConfigCategory>, IMerge
    {
        [BsonElement]
        [BsonDictionaryOptions(DictionaryRepresentation.ArrayOfArrays)]
        private Dictionary<int, MaterialReactionConfig> dict = new();
		
        public void Merge(object o)
        {
            MaterialReactionConfigCategory s = o as MaterialReactionConfigCategory;
        ...
        public MaterialReactionConfig Get(int id)
        {
            this.dict.TryGetValue(id, out MaterialReactionConfig item);

            if (item == null)
            {
                throw new Exception($"配置找不到，配置表名: {nameof (MaterialReactionConfig)}，配置id: {id}");
            }
        ...
        public Dictionary<int, MaterialReactionConfig> GetAll()
        {
            return this.dict;
        }

        public MaterialReactionConfig GetOne()
        {
	...
	public partial class MaterialReactionConfig: ProtoObject, IConfig
	{
		/// <summary>Id</summary>
