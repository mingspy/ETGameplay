namespace ET
{
    ...
    {
        [EntitySystem]
        private static void Awake(this ET.EquipComponent self)
        {
        ...
        /// 穿戴装备
        /// </summary>
        public static void WearEquip(this ET.EquipComponent self, EquipConfig config)
        {
        ...
        /// 脱下装备
        /// </summary>
        public static void RemoveEquip(this ET.EquipComponent self, int slot)
        {
